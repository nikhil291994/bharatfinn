    ...
    else
    {
        ...
        if(mysqli_query($con, $query) && mysqli_query($con, $queryOrg))
        {
            $msg = "<div class='alert alert-success'>
                        ...
                        <strong>New Sub Admin Added.</strong>
                    </div>";
        }
        else
        {
            $msg = "<div class='alert alert-danger'>
                        ...
                        <strong>Error... New Sub Admin Not Added.</strong>
                    </div>";
        }
    }
}
...
<head>
    ...
    <title>Super Admin | Create Sub Admin | Bharat Finn</title>
                                ...
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add New Team Leader</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Add New Team Leader</h4>
                                </div>
                            </div>
                        </div>

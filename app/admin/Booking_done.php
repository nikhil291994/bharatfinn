...
<head>
    ...
    <title>Super Admin | Approved Leads | Bharat Finn</title>
                                ...
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            ...
                                            <li class="breadcrumb-item active">Approved Leads</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Approved Leads</h4></div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body" style="overflow-x: auto; overflow-y: auto;">
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                    $fetch = "SELECT * FROM leads WHERE status IN ('8')  ORDER BY id DESC";

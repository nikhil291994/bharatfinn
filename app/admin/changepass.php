...
$select= "SELECT password FROM users WHERE password='".$oldpass."' && email='".$_SESSION['email']."' ";
...
if($oldpass == $pass)
{
    ...
    {   
        $update = "UPDATE users SET password = '".$encPass."', or_pass = '".$newpass."' WHERE email = '".$_SESSION['email']."' ";
        mysqli_query($con, $update);
        $msg = "<span class='alert bg-gradient2 text-white' role='alert'><strong>Well done!&nbsp;&nbsp;Password Changed Successfully..!!!</strong></span>";
...
<head>
    ...
    <title>Super Admin | Change Password | Bharat Finn</title>

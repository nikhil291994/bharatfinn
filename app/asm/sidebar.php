                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li <?php if($_SERVER['SCRIPT_NAME']=="/viewShops.php") {?> class="active" <?php } ?>>
                            ...
                            <?php
                                $newShop = "SELECT COUNT(*) AS 'countAll' FROM shopdetails WHERE  assign_subadmin_id = '".$_SESSION['subadmin_id']."'  OR assign_tele_id = '".$_SESSION['subadmin_id']."' OR under_team_leader_id = '".$_SESSION['subadmin_id']."' ORDER BY shop_id DESC";
                        ...
                        <li <?php if($_SERVER['SCRIPT_NAME']=="/addshop.php") {?> class="active" <?php } ?>>
                            <a href="addshop.php" class="waves-effect">
                                <i class="fas fa-edit"></i>

...
<form method="POST">
     ...
     <div class="row">
      ...
      <div class="col-md-3" style="width: 212px; padding-top: 29px; left: 20px;">
         <b>Lead Status :</b>
      </div>
      <div class="col-md-9" style="width: 281px; padding-top: 14px;">
         <select class="form-control" name="status" onchange="Check(this);" required>
          <option value="">Select Lead Status</option>
          <option value="1" <?php if($run2['status']=="1") echo 'selected="selected"'; ?> >New</option>
          <option value="3" <?php if($run2['status']=="3") echo 'selected="selected"'; ?> >Rejected Lead</option>
          <option value="8" <?php if($run2['status']=="8") echo 'selected="selected"'; ?> >Approved Lead</option>
         </select>         
      </div>
      ...
      <div class="col-md-9" style="width: 281px; padding-top: 14px;">
         <select class="form-control" name="login_status" onchange="Check(this);" required>

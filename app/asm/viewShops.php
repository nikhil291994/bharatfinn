                                            ...
                                            <div class="table-responsive b-0" data-pattern="priority-columns">
                                                <table id="datatable-buttons" class="table table-striped mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $x = 1;
                                                            $fetch = "SELECT * FROM shopdetails WHERE assign_subadmin_id = '".$_SESSION['subadmin_id']."' OR assign_tele_id = '".$_SESSION['subadmin_id']."' OR under_team_leader_id = '".$_SESSION['subadmin_id']."' ORDER BY shop_id  DESC";

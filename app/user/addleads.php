...
$selectId = "SELECT * FROM users WHERE username = '".$_SESSION['clientUsername']."' ";
...
if(isset($_POST['submitData']))
    {
       ...
       /* $emailCheck="SELECT * FROM leads WHERE email = '".$email."' ";
        ...
        {*/
			...
			if($query>0)
			{
				$msg = "<div class='alert bg-gradient2 text-white' role='alert'><strong>Well done!</strong> New Loan Request Sent.</div>";
				
			}
			else{
				$msg = "<div class='alert bg-gradient1 text-white' role='alert'><strong>Error!</strong> New Loan Request Not Sent.</div>";
			}
        /*}*/      
...
<head>
    ...
    <title>Client | Request for new Loan | Bharat Finn</title>
                                ...
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            <li class="breadcrumb-item"><a href="index.php">Client</a></li>
                                            <li class="breadcrumb-item active">Request for New Loan</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Request for New Loan</h4></div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body" style="height:468px;">
                                        ...
                                        <form method="POST" >                                            
                                            <!-- <div class="form-group">
                                                <label>Name</label>
                                                <div> -->
                                                    <input type="hidden" name="name" value="<?php echo $row1Id['name']; ?>" readonly class="form-control" required placeholder="Enter Name">
                                                <!-- </div>
                                            </div> -->
                                            <!-- <div class="form-group">
                                                <label>Contact No.</label>
                                                <div> -->
                                                    <input type="hidden" name="phone" maxlength="12" minlength="10" class="form-control digit" value="<?php echo $row1Id['contact']; ?>" readonly required placeholder="Enter Contact Number">
                                                <!-- </div>
                                            </div> -->
                                            <!-- <div class="form-group">
                                                <label>E-Mail</label>
                                                <div> -->
                                                    <input type="hidden" name="email" class="form-control" parsley-type="email" value="<?php echo $row1Id['email']; ?>" readonly pattern="[^@]+@[^@]+\.[a-zA-Z]{2,}" placeholder="Enter valid e-mail">
                                                <!-- </div>
                                            </div> -->
                                            <div class="form-group">

...
$all = "SELECT * FROM users WHERE username = '".$_SESSION['clientUsername']."' ";
...
<head>
    ...
    <title>Sales-Person | Profile | Bharat Finn</title>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" id="editprofile" class="form-horizontal" enctype="multipart/form-data">
                                            <!-- <div class="form-group">
                                                <label>Sharable user ID</label>
                                                <div>
                                                   <input type="text" maxlength="20" name="name" readonly value="<?php echo $show['login_id'];?>" placeholder="Enter Your Fullname" class="form-control" required>
                                                </div>
                                            </div> -->                                            
                                            <div class="form-group">
                                                <label>Name</label>
                                                <div>
                                                   <input type="text" maxlength="20" name="name" readonly value="<?php echo $show['name'];?>" placeholder="Enter Your Fullname" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>E-Mail</label>
                                                <div>
                                                   <input type="email" maxlength="40" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,}" class="form-control" value="<?php echo $show['email'];?>" name="email" id="email" placeholder="Enter Your Email-Id" readonly required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>Contact No.</label>
                                                <div>
                                                    <input type="text" class="form-control digit" maxlength="12"  minlength="10" value="<?php echo $show['contact'];?>" name="contact" id="phone"  placeholder="Enter Your Contact Number" readonly required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>ID Proof Type/Name</label>
                                                <div>
                                                    <input type="text" class="form-control digit" maxlength="12"  minlength="10" value="<?php echo $show['id_proof_type'];?>" name="contact" id="phone"  placeholder="Enter Your ID Proof Type/Name" readonly required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>ID Proof No.</label>
                                                <div>
                                                    <input type="text" class="form-control digit" maxlength="12"  minlength="10" value="<?php echo $show['id_proof_number'];?>" name="contact" id="phone"  placeholder="Enter Your ID Proof Number" readonly required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <span><b><u><font color="red">Note : For any changes contact to Administrator</font></b></u></span>
                                            </div>
                                            <!-- <div class="form-group">
                                                <label>Avatar</label>
                                ...
                                <?php } ?>
                                            ...
                                            <!-- <div class="form-group mb-0">
                                                <div>
                                                    ...
                                                    <button type="reset" class="btn btn-delete waves-effect m-l-5"><i class="fa fa-ban"></i> Reset</button>
                                                </div>
                                            </div> -->
                                        </form>
                                    </div>
                            ...
                            <!-- <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <img src='../uploads/<?php echo $show['imgPath'];?>' class='avatar' style="height:376px;width:435px;"  alt='Profile'>

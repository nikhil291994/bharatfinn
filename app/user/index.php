...
$q_follow_leads = mysqli_query($con, " SELECT COUNT(*) AS 'status' FROM leads WHERE status = '8' AND assign_tele_id = '".$show['id']."' ");
$row_follow_leads = mysqli_fetch_array($q_follow_leads);
...
$count_done = $row_follow_leads['status'];
...
<head>
    ...
    <title>Client | Dashboard | Bharat Finn</title>
                    ...
                    <div class="container-fluid">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="icon-contain">
                                                    <div class="row">
                                                        <div class="col-2 align-self-center"><i class="fas fa-tasks text-gradient-ongoing"></i></div>
                                                        <div class="col-10 text-right">
                                                            <h5 class="mt-0 mb-1"><?php echo $count_rejected; ?></h5>
                                                            <p class="mb-0 font-12 text-muted">Rejected Loans</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="icon-contain">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-10 text-right">
                                                            ...
                                                            <p class="mb-0 font-12 text-muted">New Requested Loan</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="icon-contain">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-10 text-right">
                                                            ...
                                                            <p class="mb-0 font-12 text-muted">Approved Loan</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">All Requested Loans</h4>

...
<form method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-9" style="width: 281px; padding-top: 14px;">
            <input type="number"  maxlength="12" minlength="10" class="form-control digit" name="phone"  value="<?php echo $run['mobile']; ?>" >
        </div>
        ...
        <div class="col-md-3 ifYes" style="width: 212px; padding-top: 29px; padding-bottom: 20px;">
            <b style="">Next call :</b>
        </div>

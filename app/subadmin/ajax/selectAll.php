...
<form method="POST">
     ...
     <div class="row">
      ...
      <div class="col-md-9" style="width: 281px; padding-top: 14px;">
          <select name="assign_sales_id" class="form-control">
            <option value="" selected required>Not Assigned yet</option>
      ...
      <div class="col-md-9" style="width: 281px; padding-top: 14px;">
         <select class="form-control" name="status" onchange="Check(this);">
            ...
            <option value="2" <?php if($run2['status']=="2") echo 'selected="selected"'; ?> >Hot</option>
            ...
            <option value="7" <?php if($run2['status']=="7") echo 'selected="selected"'; ?> >Following</option>
            <option value="8" <?php if($run2['status']=="8") echo 'selected="selected"'; ?> >Booking Done</option>
            <option value="9" <?php if($run2['status']=="9") echo 'selected="selected"'; ?> >Site Visit Planned</option>
            <option value="10" <?php if($run2['status']=="10") echo 'selected="selected"'; ?> >Call Back Today</option>
            <option value="11" <?php if($run2['status']=="11") echo 'selected="selected"'; ?> >Site Visit Done</option>            
         </select>         
      </div>

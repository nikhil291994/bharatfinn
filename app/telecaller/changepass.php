...
$select= "SELECT password FROM users WHERE password='".$oldpass."' && username='".$_SESSION['username']."' ";
...
if($oldpass==$pass)
{
    ...
    {   
        $update = "UPDATE users SET password = '".$encPass."', or_pass = '".$newpass."' WHERE username = '".$_SESSION['username']."' ";
...
<head>
    ...
    <title>Super-Admin | Change_Password | Bharat Finn</title>

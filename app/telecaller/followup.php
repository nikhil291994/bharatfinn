...
elseif(isset($_POST['upload'])) 
{
        ...
        else
        {
            ...
            for($row = 1; $row <= $highestRow; $row++)
            {
                ...
                if($rowData[0][0] != '' && $rowData[0][0] != '0' && $rowData[0][1] != '' && $rowData[0][1] != '0' && 
                    $rowData[0][2] != '' && $rowData[0][2] != '0' && $rowData[0][3] != '' && $rowData[0][3] != '0')
                {
                    if(function_exists('date_default_timezone_set')) {
                        date_default_timezone_set("Asia/Kolkata");
                    }
...
<head>
    ...
    <title>Telecaller | Follow-Up Today | Bharat Finn</title>
                                ...
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            ...
                                            <li class="breadcrumb-item active">Follow Up Today</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Follow-up Today</h4></div>
                            </div>
                        </div>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $fetch = "SELECT * FROM leads WHERE assign_tele_id = '".$show['id']."' AND status=5 AND next_call = '".$todaydate."' ORDER BY id DESC";
